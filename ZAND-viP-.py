...
|  $$    \| $$  | $$| $$  \$$$| $$    $$
 \$$$$$$$$ \$$   \$$ \$$   \$$ \$$$$$$$ 
   ...
   {M}[ {P}Author   : kak_ZAND {M}]
   {M}[ {P}Admin : kak_ZAND {M}]
   {M}[ {P}Telegram : iam_zand {M}]
   {M}[ {P}Github   : zand4545 {M}]""")
...
def chk():
    ...
    print("\n\n\x1b[37;1m  ID : \033[94m"+id) 

    httpCaht = requests.get("https://github.com/Zand4545/zand45/blob/main/Idactive.md").text
    if id in httpCaht:
            
        print(colorama.Fore.GREEN+"ID Active Krawa ...  ") 
        print("\nchawarwan ba ...")
        msg = str(os.geteuid()) 
        time.sleep(3) 
        pass 
        ...
        os.system('clear')
        print('ID : '+id)
        print(colorama.Fore.YELLOW+"Bo active krdn nama bo xawanakay bnera @iam_zand")
        time.sleep(4)
        os.system('xdg-open https://t.me/iam_zand')
        time.sleep(1) 
        l = input('')
        sys.exit()
        chk()
